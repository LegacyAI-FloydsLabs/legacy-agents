# mobile-web-IDE — FLOYD.md
**Version:** 1.7.0
**Initialized:** 2026-04-23T03:15:11-0400
...
You are working on **mobile-web-IDE**, a Legacy AI project.
...
4. Read `SSOT/mobile-web-IDE_SSOT.md` for current project state. Perform the Verification Sweep Protocol defined in `.supercache/contracts/document-management.md` for sections relevant to your task.
5. Read `Issues/mobile-web-IDE_ISSUES.md` for open issues and blockers.
...
|----------------------|--------------------------------------------------|-------------------------------------------------|
| `SSOT/`              | Project status, decisions, findings, verification | `SSOT/mobile-web-IDE_SSOT.md`, `SSOT/decision-log.md` |
| `Issues/`            | Bugs, blockers, tasks, help-desk ledger          | `Issues/mobile-web-IDE_ISSUES.md`, `Issues/0001-description.md` |
