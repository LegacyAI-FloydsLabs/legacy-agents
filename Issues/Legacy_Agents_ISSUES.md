...
> and issue tracker for **Legacy_Agents**.

---

## How to use this document

- This is the living help-desk for repo operations, CI/CD, bugs, and blockers for Legacy_Agents.
...
```
Issues/
├── Legacy_Agents_ISSUES.md       (this file — the ledger)
...
- 2026-04-29T07:31:47-0400 — Initialized issues ledger.
