...
> document for architecture and programmatic change facts of **mobile-web-IDE**.

---

## Authority

This document is the **single source of truth** for architecture and programmatic change facts of mobile-web-IDE. All other documents must be treated as **potentially flawed** unless their facts are confirmed here.
...
3. If any fact cannot be verified to 100% confidence:
   ...
   - Add an entry to `Issues/mobile-web-IDE_ISSUES.md` to track the discrepancy
...
|---|---|---|---|
| 2026-04-24T22:42:04-0400 | <!-- Example: Chose X over Y --> | <!-- Example: because Z --> | <!-- Name or "Unassigned" --> |
...
- 2026-04-24T22:42:04-0400 — Initialized SSOT.
