...
You are working on **Legacy_Agents**, a Legacy AI project.
...
4. Read `SSOT/Legacy_Agents_SSOT.md` for current project state. Perform the Verification Sweep Protocol defined in `.supercache/contracts/document-management.md` for sections relevant to your task.
5. Read `Issues/Legacy_Agents_ISSUES.md` for open issues and blockers.
...
|----------------------|--------------------------------------------------|-------------------------------------------------|
| `SSOT/`              | Project status, decisions, findings, verification | `SSOT/Legacy_Agents_SSOT.md`, `SSOT/decision-log.md` |
| `Issues/`            | Bugs, blockers, tasks, help-desk ledger          | `Issues/Legacy_Agents_ISSUES.md`, `Issues/0001-description.md` |
